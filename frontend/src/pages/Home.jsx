      ...
      <div class="max-w-screen-xl mx-auto  grid grid-cols-1 md:grid-cols-2">
        <div className='relative'>
          ...
          <div className="absolute inset-0 flex items-center justify-center mt-60">
            <Link to={'/womans'}>
              <h2 className=" underline text-gray-200 font-playfair text-6xl font-bold">Coleção <br />Feminina</h2>
            </Link>
        </div>
        </div>
        <div className='relative'>
          ...
          <div className="absolute inset-0 flex items-center justify-center mt-60">
            <Link to={'/mens'}>
              <h2 className="underline text-gray-200 font-playfair text-6xl font-bold ">Coleção <br />Masculina</h2>
            </Link>
        </div>
        </div>
      </div>
      ...
      <section className="py-10 mt-8">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
          ...
          <div className="bg-white rounded-2xl p-6 flex flex-col items-center">
            ...
            <h4 className="text-lg font-semibold mb-2">Site Seguro</h4>
            <p className="text-gray-600">Ambiente protegido para uma compra tranquila.</p>
          </div>

          <div className="bg-white rounded-2xl p-6 flex flex-col items-center">
            <BadgeCheck className="w-30 h-30 text-gray-700 mb-5" />
            <h4 className="text-lg font-semibold mb-2">Qualidade Garantida</h4>
            <p className="text-gray-600">Peças selecionadas com excelência e sofisticação.</p>
          </div>
